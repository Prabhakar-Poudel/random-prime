...
describe('isPrime()', () => {
  it('returns true for prime numbers', () => {
    ...
    expect(isPrime(15_487_403)).toBeTruthy()
    expect(isPrime(32_416_190_071)).toBeTruthy()
  })
  it('returns false for non-prime numbers', () => {
    ...
    expect(isPrime(15_487_402)).toBeFalsy()
    expect(isPrime(32_416_190_079)).toBeFalsy()
  })
...
describe('eachPrime()', () => {
  it('returns true for prime numbers', () => {
    ...
    expect(eachPrime([101, 15_487_403, 32_416_190_071])).toBeTruthy()
  })
  it('returns false for any non-prime number in the list', () => {
    ...
    expect(eachPrime([32_416_190_071, 15_487_403, 235])).toBeFalsy()
    expect(eachPrime([13, 15_487_402])).toBeFalsy()
    expect(eachPrime([32_416_190_079])).toBeFalsy()
  })
  it('throws error for invalid inputs', () => {
